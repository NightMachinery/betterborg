...
Bot admins can use =.codex-users= to see explicitly allowlisted non-admin users
and their personal default models. Select a user to change their default, or
use =.codex-users <user-id> <model-id>= to set it immediately.
