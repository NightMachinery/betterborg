...
=llm_chat= refreshes Telegram reaction metadata before building model history so
reacted messages can include aggregate reaction text. See
[[file:docs/llm_chat_reactions.md][docs/llm_chat_reactions.md]].
