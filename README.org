...
=llm_chat= adds Telegram reaction metadata to model history when available. Userbot
sessions can refresh it retrospectively; bot sessions use a live reaction-update
cache and require bot admin status in the group. Set
