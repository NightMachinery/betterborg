...
as admin-only chat models using the published =llm-openai-via-codex= package and
local Codex OAuth credentials. See [[file:docs/codex_models.md][docs/codex_models.md]] and
