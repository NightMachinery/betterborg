...
=BORG_HISTORY_EXPORT_DIR= to override the root directory. Media files are not
downloaded; placeholders and available media metadata are written instead. See
